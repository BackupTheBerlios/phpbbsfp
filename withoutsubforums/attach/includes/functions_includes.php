...
//--------------------------------------------------------------------------------------------------
//
// $Id: functions_includes.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : functions_includes.php
...
function attach_faq_include($lang_file)
{
    ...
    {
        if ( !@file_exists(@realpath($phpbb_root_path . 'language/lang_' . $board_config['default_lang'] . '/lang_faq_attach.'.$phpEx)) )
        {
