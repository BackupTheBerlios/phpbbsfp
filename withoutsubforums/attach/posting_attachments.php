...
//--------------------------------------------------------------------------------------------------
//
// $Id: posting_attachments.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : posting_attachments.php
...
//      $priority = 'group;user';
    ...
    function display_attachment_bodies()
    {
        ...
        $template->assign_vars(array(
            ...
            'RULES' => '<a href="' . append_sid($phpbb_root_path . "attach/attach_rules.$phpEx?f=$u_rules_id") . '" target="_blank">' . $lang['Allowed_extensions_and_sizes'] . '</a>',
