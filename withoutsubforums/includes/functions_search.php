...
//--------------------------------------------------------------------------------------------------
//
// $Id: functions_search.php,v 1.1 2004/08/30 21:30:06 dmaj007 Exp $
//
// FILENAME  : functions_search.php
...
function username_search($search_match, $multi)
...
//-- modify
        ...
        'S_SEARCH_ACTION' => append_sid("search.$phpEx?mode=searchuser" . ($multi ? '&multi=1' : '')))
