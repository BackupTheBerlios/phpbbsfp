...
//--------------------------------------------------------------------------------------------------
//
// $Id: functions_cash.php,v 1.1 2004/08/30 21:30:06 dmaj007 Exp $
//
// FILENAME  : functions_cash.php
...
class cash_currency
{
    ...
    {
                if ( $amount === NULL ) // ToonArmy Quick Fix ;-)
  	                 {
  	                         return;
  	                 } // Xore Will Do a proper fix for the next release :-D
