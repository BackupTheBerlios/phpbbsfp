...
//--------------------------------------------------------------------------------------------------
//
// $Id: auth.php,v 1.1 2004/08/30 21:30:06 dmaj007 Exp $
//
// FILENAME  : auth.php
...
function auth($type, $forum_id, $userdata, $f_access = '')
{
    ...
    {
        case AUTH_ALL:
            $a_sql = 'a.auth_view, a.auth_read, a.auth_post, a.auth_reply, a.auth_edit, a.auth_delete, a.auth_sticky, a.auth_announce, a.auth_vote, a.auth_pollcreate, a.auth_ban, a.auth_greencard, a.auth_bluecard, a.auth_attachments, a.auth_download';
            $auth_fields = array('auth_view', 'auth_read', 'auth_post', 'auth_reply', 'auth_edit', 'auth_delete', 'auth_sticky', 'auth_announce', 'auth_vote', 'auth_pollcreate', 'auth_ban', 'auth_greencard', 'auth_bluecard', 'auth_attachments', 'auth_download');
            break;
        case AUTH_VIEW:
            $a_sql = 'a.auth_view';
