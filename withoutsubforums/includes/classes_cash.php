...
//--------------------------------------------------------------------------------------------------
//
// $Id: classes_cash.php,v 1.1 2004/08/30 21:30:06 dmaj007 Exp $
//
// FILENAME  : classes_cash.php
...
if ( defined('CM_MEMBERLIST') )
{
    ...
    {
		function cm_memberlist(&$boop,&$beep){
            ...
            while ( $c_cur = &$cash->currency_next($cm_i,CURRENCY_ENABLED | CURRENCY_VIEWMEMBERLIST) )
            {
                ...
                $beep['PCP.buddy']['fields'][$c_cur->db()] = array(
                'leg'          => true,
                'txt'          => true,
