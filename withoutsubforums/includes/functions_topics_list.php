...
//--------------------------------------------------------------------------------------------------
//
// $Id: functions_topics_list.php,v 1.1 2004/08/30 21:30:06 dmaj007 Exp $
//
// FILENAME  : functions_topics_list.php
...
// TODO :
//	Make the funcs tpl assignment friendlier.
...
//-- mod : topic description -----------------------------------------------------------------------
//-- add
			'TOPIC_DESCRIPTION' => $bbcode_parse->smilies_pass($topic_desc),
...
//-- end mod : topic description -------------------------------------------------------------------
	...
	unset($sav_tpl); // Man that would be big :), can be do this elegently.
