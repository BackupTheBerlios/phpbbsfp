...
//--------------------------------------------------------------------------------------------------
//
// $Id: functions_post.php,v 1.1 2004/08/30 21:30:06 dmaj007 Exp $
//
// FILENAME	 : functions_post.php
...
{
	global $board_config, $html_entities_match, $html_entities_replace, $bbcode_parse;
	...
	{
		$message = $bbcode_parse->bbencode_first_pass($message, $bbcode_uid);
	}
...
{
	global $board_config, $userdata, $lang, $phpEx, $phpbb_root_path, $bbcode_parse;
...
function update_post_stats(&$mode, &$post_data, &$forum_id, &$topic_id, &$post_id, &$user_id)
{
	...
	// if ($mode != 'poll_delete')
	// Previous line replaced by next line for Advanced Post Count Mod
	if ($mode != 'poll_delete' && !in_array($forum_id, $npcfid))
	{
