...
//--------------------------------------------------------------------------------------------------
//
// $Id: admin_extensions.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : admin_extensions.php
...
if ($mode == 'groups')
{
    ...
    //
    $template->set_filenames(array(
        'body' => 'attach_extension_groups.tpl')
    );
...
{
    $template->set_filenames(array(
        'body' => 'attach_forbidden_extensions.tpl')
    );
...
if (($e_mode == 'perm') && ($group != -1))
{
    ...
    $template->set_filenames(array(
        'perm_box' => 'extension_groups_permissions.tpl')
    );
