...
//--------------------------------------------------------------------------------------------------
//
// $Id: admin_attach_cp.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : admin_attach_cp.php
...
if ($view == 'attachments')
{
    ...
    $template->set_filenames(array(
        'body' => 'attach_cp_attachments.tpl')
    );
