...
//--------------------------------------------------------------------------------------------------
//
// $Id: admin_pcp_userfields.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : admin_pcp_userfields.php
...
if ( ($mode == 'sqlcreate') || ($mode == 'sqledit') )
{
	...
	else
	{
		...
		$template->set_filenames(array(
			'body' => 'pcp_userfields_sql_body.tpl')
		);
...
if ( $mode == 'edit' )
{
	...
	else if ($mode == 'edit')
	{
		// template
		$template->set_filenames(array(
			'body' => 'pcp_userfields_edit_body.tpl')
		);
