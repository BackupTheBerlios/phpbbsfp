...
//--------------------------------------------------------------------------------------------------
//
// $Id: cash_config.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : cash_config.php
...
while ( $row = $db->sql_fetchrow($result) )
{
		 ...
		 isset($HTTP_POST_VARS[$config_name]) )
	{
		...
		if ( $sql = set_config($config_name, $HTTP_POST_VARS[$config_name]) )
		{
