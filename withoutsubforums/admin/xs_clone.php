...
//--------------------------------------------------------------------------------------------------
//
// $Id: xs_clone.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : xs_clone.php
...
if(!empty($HTTP_GET_VARS['clone']))
{
	...
	$template->set_filenames(array('body' => 'clone2.tpl'));
	// clone template
...
$template->set_filenames(array('body' => 'clone.tpl'));
$template->pparse('body');
xs_exit();
