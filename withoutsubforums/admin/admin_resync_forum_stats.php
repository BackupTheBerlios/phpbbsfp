...
//--------------------------------------------------------------------------------------------------
//
// $Id: admin_resync_forum_stats.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : admin_resync_forum_stats.php
...
if(!isset($HTTP_POST_VARS['doresync']))
{
    if(!isset($HTTP_GET_VARS['mode'])||$HTTP_GET_VARS['mode']=='simple')
    {
        ...
        $template->set_filenames(array(
            "body" => "admin_resync_forum_stats_smp.tpl")
        );
    ...
    else
    {
        // Set template file
        $template->set_filenames(array(
            "body" => "admin_resync_forum_stats_adv.tpl")
        );
