...
//--------------------------------------------------------------------------------------------------
//
// $Id: admin_lang_extend.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : admin_lang_extend.php
...
if ($mode == 'pack')
{
	...
	else
	{
		// template
		$template->set_filenames(array(
			'body' => 'lang_extend_pack_body.tpl')
		);
...
if ( $mode == 'search' )
{
	...
	else
	{
		...
		// template
		$template->set_filenames(array(
			'body' => 'lang_extend_search_body.tpl')
		);
