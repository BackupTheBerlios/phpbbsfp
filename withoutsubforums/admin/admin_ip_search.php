...
//--------------------------------------------------------------------------------------------------
//
// $Id: admin_ip_search.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : admin_ip_search.php
...
if( $submit )
{
    ...
    $template->set_filenames(array(
        'viewip' => 'ipsearch_results_body.tpl')
    );
...
{
    $template->set_filenames(array(
        'search' => 'ipsearch_search_body.tpl')
    );
    $template->assign_vars(array(
