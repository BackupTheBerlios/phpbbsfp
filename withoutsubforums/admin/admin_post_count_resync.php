...
//--------------------------------------------------------------------------------------------------
//
// $Id: admin_post_count_resync.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
...
if( !empty($setmodules) )
{
    ...
    $module['Forums']['Resync_Post_counts'] = append_sid($filename);
    return;
}
    ...
    switch($mode)
    {
        case 'advanced':
            ...
            $template->set_filenames(array(
                "body" => "admin_pcount_resync_adv.tpl")
            );
        ...
        case 'simple':
            $template->set_filenames(array(
                "body" => "admin_pcount_resync_simple.tpl")
            );
