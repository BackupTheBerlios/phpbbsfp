...
//--------------------------------------------------------------------------------------------------
//
// $Id: xs_import.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : xs_import.php
...
if(!empty($HTTP_GET_VARS['importstyle']))
{
	...
	$template->set_filenames(array('import' => 'import2.tpl'));
...
$template->set_filenames(array('body' => 'import.tpl'));
//
