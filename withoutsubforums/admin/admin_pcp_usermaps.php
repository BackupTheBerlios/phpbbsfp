...
//--------------------------------------------------------------------------------------------------
//
// $Id: admin_pcp_usermaps.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : admin_pcp_usermaps.php
...
if ( $mode == 'edit' )
{
	...
	if ( !$edit_field && !$edit_title && !$add_field && !$add_title )
	{
		...
		else
		{
			// template
			$template->set_filenames(array(
				'body' => 'pcp_usermaps_edit_body.tpl')
			);
