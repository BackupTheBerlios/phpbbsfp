...
//--------------------------------------------------------------------------------------------------
//
// $Id: admin_pcp_valueslist.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : admin_pcp_valueslist.php
...
if ($mode == 'edit')
{
	...
	else
	{
		...
		$template->set_filenames(array(
			'body' => 'pcp_valueslist_edit_body.tpl')
		);
