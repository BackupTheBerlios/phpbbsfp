...
//--------------------------------------------------------------------------------------------------
//
// $Id: admin_forum_prune.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : admin_forum_prune.php
...
if( isset($HTTP_POST_VARS['doprune']) )
{
    ...
    $template->set_filenames(array(
        'body' => 'forum_prune_result_body.tpl')
    );
...
else
{
    ...
    if( empty($HTTP_POST_VARS[POST_FORUM_URL]) )
    {
        ...
        //
        $template->set_filenames(array(
            'body' => 'forum_prune_select_body.tpl')
        );
