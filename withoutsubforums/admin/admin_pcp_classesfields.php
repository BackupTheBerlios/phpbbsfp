...
//--------------------------------------------------------------------------------------------------
//
// $Id: admin_pcp_classesfields.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : admin_pcp_classesfields.php
...
if ( $mode == 'edit' )
{
	...
	else
	{
		...
		$template->set_filenames(array(
			'body' => 'pcp_classesfields_edit_body.tpl')
		);
...
if ($mode == '')
{
	// template
	$template->set_filenames(array(
		'body' => 'pcp_classesfields_body.tpl')
	);
