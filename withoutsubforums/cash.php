...
//--------------------------------------------------------------------------------------------------
//
// $Id: cash.php,v 1.1 2004/08/30 21:30:05 dmaj007 Exp $
//
// FILENAME  : cash.php
...
$layout = $core_layout[LAYOUT_CASH];
...
if (isset($HTTP_POST_VARS['ref']))
{
    $ref = $HTTP_POST_VARS['ref'];
}
elseif (isset($HTTP_GET_VARS['ref']))
{
...
if (isset($HTTP_POST_VARS[POST_USERS_URL]))
{
    $target = intval($HTTP_POST_VARS[POST_USERS_URL]);
}
elseif (isset($HTTP_GET_VARS[POST_USERS_URL]))
{
    $target = intval($HTTP_GET_VARS[POST_USERS_URL]);
}
elseif (isset($HTTP_POST_VARS['u']))
{
    $target = intval($HTTP_POST_VARS['u']);
}
elseif (isset($HTTP_GET_VARS['u']))
{
    $target = intval($HTTP_GET_VARS['u']);
}
else
{
    $target = 0;
...
{
    $post = intval($HTTP_POST_VARS[POST_POST_URL]);
}
elseif (isset($HTTP_GET_VARS[POST_POST_URL]))
{
    $post = intval($HTTP_GET_VARS[POST_POST_URL]);
}
elseif (isset($HTTP_POST_VARS['p']))
{
    $post = intval($HTTP_POST_VARS['p']);
}
elseif (isset($HTTP_GET_VARS['p']))
{
    $post = intval($HTTP_GET_VARS['p']);
}
else
{
    $post = 0;
