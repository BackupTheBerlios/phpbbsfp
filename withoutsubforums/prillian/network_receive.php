...
//--------------------------------------------------------------------------------------------------
//
// $Id: network_receive.php,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $
//
// FILENAME	 : network_receive.php
...
else
{
    ...
    if( !$error )
    {
        ...
        $sql_info = 'INSERT INTO ' . INSTMSGS_TABLE . ' (site_id, instmsgs_type, instmsgs_subject, instmsgs_from_username, instmsgs_from_userid, instmsgs_to_userid, instmsgs_date, instmsgs_ip, instmsgs_enable_html, instmsgs_enable_bbcode, instmsgs_enable_smilies, instmsgs_attach_sig)
            VALUES (' . $site_info['site_id'] . ", " . IM_NEW_MAIL . ", '" . str_replace("\'", "''", $instant_subject) . "', '" . str_replace("\'", "''", $from_username) . "', $from_userid, " . $to_userdata['user_id'] . ", $msg_time, '$user_ip', $html_on, $bbcode_on, $smilies_on, $attach_sig)";
