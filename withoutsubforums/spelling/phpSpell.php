...
<table width="550" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr ><td <?php if ($theme['body_background'] != "") echo " background=\"../".$theme['body_background']."\""; ?>>
    <table border=0 cellspacing=1 cellpadding=0 width=550 class=forumline>
     ...
     <tr class="catleft"><td><span class="copyright">&nbsp;<a href="http://www.master-technology.com/demos/spell" target="_blank">(c)Copyright 2002-2004, Team phpSpell.</a></span></td></tr>
    </table>
  </td></tr></table>
</form>
</body>
