<!-- $Id: viewforum_body.tpl,v 1.1 2004/08/30 21:32:17 dmaj007 Exp $ -->

	<!-- IF S_FORUM_RULES -->
	<!-- I am not sure of the positioning of this. <br clear="all" /> -->
	
	<div class="forumrules">
	<span class="genmed" style="color: red; font-weight: bold;">{L_FORUM_RULES}</span><br />
	{FORUM_RULES}
	</div>
  ...
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
    ...
    <tr>
      ...
      <td align="left" valign="middle" class="nav" width="100%"><span class="nav">&nbsp;&nbsp;&nbsp;<a href="{U_FORUM}" class="nav">{L_FORUM}</a> -> <a class="nav" href="{U_VIEW_FORUM}">{FORUM_NAME}</a></span></td>
...
<form method="post" action="{S_POST_DAYS_ACTION}">
   <table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
     ...
     <tr> 	 
       <td class="row1" colspan="6" align="center" valign="middle"><span class="gen">{L_NO_TOPICS}</span></td> 	 
     </tr> 	 
  ...
  <table width="100%" cellspacing="2" border="0" align="center" cellpadding="2">
    <tr>
    <td align="left" valign="middle" width="50"><a href="{U_POST_NEW_TOPIC}"><img src="{POST_IMG}"   alt="{L_POST_NEW_TOPIC}"></a></td>
      <td align="left" valign="middle" width="100%"><span class="nav">&nbsp;&nbsp;&nbsp;<a href="{U_FORUM}" class="nav">{L_FORUM}</a> -> <a class="nav" href="{U_VIEW_FORUM}">{FORUM_NAME}</a></span></td>
