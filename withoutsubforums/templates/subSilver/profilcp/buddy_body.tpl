<!-- $Id: buddy_body.tpl,v 1.1 2004/08/30 21:32:17 dmaj007 Exp $ -->
...
<tr>
    <td valign="top" align="center" colspan="2">
        ...
        <!-- END userfields_row -->
        <tr>
            <td class="catBottom" colspan="{COLSPAN}" align="center">
                {S_HIDDEN_FIELDS}
...
<tr>
    <td valign="top" align="center" colspan="2">
        ...
        <!-- BEGIN select -->
        <tr>
            <td class="catBottom" colspan="{ROW_SPAN}" align="left" valign="top" nowrap="nowrap">
                <span class="genmed">
                    ...
                    <input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="liteoption" onClick="window.open('{U_SEARCH_USER}', '_minervasearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" />
