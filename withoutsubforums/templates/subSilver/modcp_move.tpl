<!-- $Id: modcp_move.tpl,v 1.1 2004/08/30 21:32:17 dmaj007 Exp $ -->
<form action="{S_MODCP_ACTION}" method="post">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
    <tr>
      <td align="left" class="nav"><a href="{U_FORUM}" class="nav">{L_FORUM}</a></td>
    </tr>
  </table>
  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
    <tr>
      <th class="thHead"><b>{MESSAGE_TITLE}</b></th>
    </tr>
    <tr>
      <td class="row1">
