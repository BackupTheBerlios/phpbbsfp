<!-- $Id: viewtopic_poll_result.tpl,v 1.1 2004/08/30 21:32:17 dmaj007 Exp $ -->
<tr>
            ...
            <tr>
              ...
              <td>
                <table cellspacing="0" cellpadding="0" border="0">
                  <tr>
                    <td><img src="{TEMPLATE}images/vote_lcap.gif" width="4" alt="" height="12" /></td>
                    ...
                    <td><img src="{TEMPLATE}images/vote_rcap.gif" width="4" alt="" height="12" /></td>
                  </tr>
                </table>
              </td>
