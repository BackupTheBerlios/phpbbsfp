<!-- $Id: search_body.tpl,v 1.1 2004/08/30 21:32:17 dmaj007 Exp $ -->
<form action="{S_SEARCH_ACTION}" method="POST"><table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
    <tr>
        <td align="left"><span class="nav"><a href="{U_FORUM}" class="nav">{L_FORUM}</a></span></td>
    </tr>
</table>
...
<table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
    ...
    <tr> 
		<td class="row1" colspan="2"><span class="gen">{L_TOPIC_STARTER}:</span></td> 
		<td class="row2" colspan="2" valign="middle"><span class="genmed"><input type="radio" name="topic_starter" value="1" /> {L_YES}&nbsp;&nbsp;<input type="radio" name="topic_starter" value="0" checked="checked" /> {L_NO}</span></td> 
	</tr>
    <tr>
    ...
    <tr>
        ...
        <td class="catBottom" colspan="4" align="center">{S_HIDDEN_FIELDS}<input class="liteoption" type="submit" value="{L_SEARCH}" /></td>
    </tr>
</table>
