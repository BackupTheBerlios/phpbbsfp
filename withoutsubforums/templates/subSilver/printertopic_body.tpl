<!-- $Id: printertopic_body.tpl,v 1.1 2004/08/30 21:32:17 dmaj007 Exp $ -->
...
<span class="nav"><a href="{U_INDEX}" class="nav"><font color=black>{SITENAME}</font></a><a href="{U_FORUM}" class="nav"><font color=black>{L_FORUM_NAME}</font></a>{NAV_CAT_DESC}</span>
	...
	<span class="name"><a name="{postrow.U_POST_ID}"></a></span><span class="postdetails">#{postrow.POST_NUMBER}:&nbsp;<font color=black><b>{postrow.POST_SUBJECT}</b> {L_AUTHOR}:&nbsp;<b>{postrow.POSTER_NAME}</b>,&nbsp;</font></span><a href="{postrow.U_MINI_POST}"><img src="{postrow.MINI_POST_IMG}" width="12" height="9" alt="{postrow.L_MINI_POST_ALT}" title="{postrow.L_MINI_POST_ALT}" border="0" /></a><span class="postdetails"><font color=black>{L_POSTED}: {postrow.POST_DATE}</font><span class="gen"><br>
