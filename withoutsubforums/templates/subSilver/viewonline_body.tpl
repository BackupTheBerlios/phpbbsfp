<!-- $Id: viewonline_body.tpl,v 1.1 2004/08/30 21:32:17 dmaj007 Exp $ -->
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <tr>
    <td class="catSides" colspan="3"><span class="cattitle"><b>{TOTAL_REGISTERED_USERS_ONLINE}</b></span></td>
  </tr>
  <!-- BEGIN reg_user_row -->
  <tr>
  ...
  <!-- END reg_user_row -->
  <tr>
    <td colspan="3" height="1" class="row3"><img src="{TEMPLATE}images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
  <tr>
    <td class="catSides" colspan="3"><span class="cattitle"><b>{TOTAL_GUEST_USERS_ONLINE}</b></span></td>
  </tr>
