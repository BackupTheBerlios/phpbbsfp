                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        <select name="smile_url" onchange="javascript:update_smiley(this.options[selectedIndex].value);">
                            <option selected value="templates/subSilver/images/spacer.gif">{L_SELECT_SMILE}</option>
                            <!-- BEGIN smilies_row -->
                        ...
                        <a href="javascript:emoticon(document.post.smile_url.options[document.post.smile_url.selectedIndex].id);"><img name="smiley_image" src="templates/subSilver/images/spacer.gif" border="0"></a>
