<!-- $Id: rating_index_body.tpl,v 1.1 2004/08/30 21:32:17 dmaj007 Exp $ -->
<!--
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	...
	<!-- BEGIN notopics -->
		<td class="row1" align="left" valign="top"><span class="gensmall">{notopics.MESSAGE}</span></td>
	<!-- END notopics -->
	<!-- BEGIN ratingrow -->
	<tr>
		<td class="row1" align="left" valign="top"><span class="gensmall">{ratingrow.RATING} : <a href="{ratingrow.URL}">{ratingrow.TITLE}</a></span></td>
	</tr>
	<!-- END ratingrow -->
</table>