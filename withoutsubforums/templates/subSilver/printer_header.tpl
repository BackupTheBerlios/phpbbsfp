...
/* Code blocks */
.code{background:#fafafa;border:1px solid #d1d7dc;font-size:11px;line-height:125%}
.codetitle{background: #cdd6de;border:1px solid #9ca9b4;padding:5px;width:90%;font-weight:bold; text-align:left; margin-top:10px}
.codediv{background:#fafafa;border: 1px solid #9ca9b4;border-top:0; padding:5px;overflow:auto;width:90%;text-align:left}
...
function codeDivStart() {
  document.write('<\/div><div class="codediv">');
}
//]]>
</script>
