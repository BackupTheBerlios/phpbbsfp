<!-- $Id: modcp_split.tpl,v 1.1 2004/08/30 21:32:17 dmaj007 Exp $ -->
<form method="post" action="{S_SPLIT_ACTION}">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
    <tr>              
	  <td align="left" class="nav"><a href="{U_FORUM}" class="nav">{L_FORUM}</a><span class="nav"> 
    ...
    <tr>
      ...
      <td width="100%" valign="top" class="{postrow.ROW_CLASS}">
        <table width="100%" cellspacing="0" cellpadding="3" border="0">
          <tr>
            <td valign="middle"><img src="{TEMPLATE}images/icon_minipost.gif" alt="{L_POST}"><span class="postdetails">{L_POSTED}:
