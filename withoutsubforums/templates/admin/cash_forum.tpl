<!-- $Id: cash_forum.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
{NAVBAR}
...
<form method="post" action="{S_FORUM_ACTION}"><table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline" align="center">
    ...
    <!-- END forumrow -->
    <tr>
        <td colspan="{NUM_ROWS}" height="1" class="spaceRow"><img src="{TEMPLATE}images/spacer.gif" alt="" width="1" height="1" /></td>
    </tr>
    <!-- END catrow -->
    <tr>
