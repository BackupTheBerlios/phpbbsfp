<!-- $Id: jr_admin_user_permissions.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
...
<table width="100%" cellspacing="2" cellpadding="2" border="1" align="center">
	<tr>
		<td align="center">
			<span class="gen">{L_STATUS}<br /></span><span class="genmed"><b>{I_STATUS_MESSAGE}</b></span><br />
		</td>
	</tr>
</table>
<!-- END statusrow -->
...
<table  border="0" cellpadding="3" cellspacing="1" class="forumline" align="center" width="90%">
	<tr>
		<th class="thHead" width="50%">{L_USER_STATS}</th>
		<th class="thHead" width="50%">{L_USER_INFO}</th>
	</tr>
	<tr>
		<td align="center" class="row1" valign="middle">
			<span class="gen"><b>{USERNAME}</b></span><br />{GROUP_NAME}<br /><span class="gensmall">{ADMIN_TEXT}</span>
		</td>
	...
	<tr>
		<td class="row1" align="center"><span class="genmed"><b>{L_START_DATE}</b><br />{START_DATE}</span><br /><br /><span class="genmed"><b>{L_UPDATE_DATE}</b><br />{UPDATE_DATE}</span></td>
		<td class="row3" colspan="2" align="center"><span class="gensmall"><b>{L_NOTES}</b> &nbsp;&nbsp;&nbsp; {L_ALLOW_VIEW}<input type="checkbox" name="notes_view" value="1" {NOTES_VIEW_CHECKED}></span><br /><TEXTAREA name="admin_notes" class="post" cols="45" rows="5">{NOTES}</TEXTAREA></td>
	</tr>
</table>
<br />
<form action="{S_ACTION}" name="module_form" method="post">
<table  border="0" cellpadding="3" cellspacing="1" class="forumline" align="center" width="95%">
	<tr>
		<th class="thHead" height="25" valign="middle" colspan="3">{L_MODULE_INFO}</th>
	</tr>
	<tr>
		<td class="row1" colspan="3" align="center" height="28"><input type="submit" name="update_user" value="{L_UPDATE}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" name="reset" class="liteoption" /></td>
	</tr>
	<tr>
		<td class="catBottom" align="right">&nbsp;</td>
		<td class="catBottom" align="center" width="10%">
			<input type="checkbox" name="check_all_page" onClick="toggle_check_all(check_all_page, 1);">
		</td>
