<!-- $Id: user_ban_body.tpl,v 1.1 2004/08/30 21:30:08 dmaj007 Exp $ -->
<h1>{L_BAN_TITLE}</h1>
...
<form method="post" name="post" action="{S_BANLIST_ACTION}"><table width="80%" cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
    ...
    <tr>
      ...
      <td class="row2"><input class="post" type="text" class="post" name="username" maxlength="50" size="20" /> <input type="hidden" name="mode" value="edit" />{S_HIDDEN_FIELDS} <input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="liteoption" onClick="window.open('{U_SEARCH_USER}', '_minervasearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></td>
    </tr>
    <tr>
