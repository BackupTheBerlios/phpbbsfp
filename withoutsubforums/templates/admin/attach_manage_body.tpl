<!-- $Id: attach_manage_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
...
<table width="99%" cellpadding="4" cellspacing="1" border="0" align="center" class="forumline">
    ...
    <tr>
        ...
        <td class="row2"><input type="text" maxlength="100" name="upload_dir" class="post" value="{UPLOAD_DIR}" /></td>
    </tr>
    <tr>
        <td class="row1" width="80%">{L_ATTACHMENT_IMG_PATH}<br /><span class="gensmall">{L_IMG_PATH_EXPLAIN}</span></td>
        <td class="row2"><input type="text" maxlength="100" name="upload_img" class="post" value="{ATTACHMENT_IMG_PATH}" /></td>
    </tr>
    <tr>
        <td class="row1" width="80%">{L_ATTACHMENT_TOPIC_ICON}<br /><span class="gensmall">{L_TOPIC_ICON_EXPLAIN}</span></td>
        <td class="row2"><input type="text" maxlength="100" name="topic_icon" class="post" value="{TOPIC_ICON}" /></td>
    </tr>
    <tr>
