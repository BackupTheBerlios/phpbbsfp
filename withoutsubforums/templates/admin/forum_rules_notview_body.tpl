<!-- $Id: forum_rules_notview_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
...
<tr>
	<td class="catBottom" align="center" colspan="2"><input type="hidden" name="all_user_notview_rules" value="{S_HIDDEN_VARS}" />
