<!-- $Id: pcp_usermaps_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
<h1>{L_TITLE}</h1>
...
<!-- END sub -->
<tr>
	<td class="catbottom" align="center" colspan="3">{S_HIDDEN_FIELDS}
...
<tr>
	<td class="catbottom" align="center" colspan="4">{S_HIDDEN_FIELDS}
