<!-- $Id: imclient_admin_config.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
...
<input type="hidden" name="allow_chat" value="1" />
    ...
    <tr>
        ...
        <td class="row2" align="center">
            <input type="text" size="4" maxlength="4" name="mode1_width" value="{MODE1_WIDTH}" />
        </td>
        <td class="row2" align="center">
    ...
    <tr>
        ...
        <td class="row2" align="center">
            <input type="text" size="4" maxlength="4" name="prefs_width" value="{PREFS_WIDTH}" />
        </td>
        <td class="row2" align="center">
    ...
    <tr>
        ...
        <td class="row2" align="center">
            <input type="text" size="4" maxlength="4" name="read_width" value="{READ_WIDTH}" />
        </td>
        <td class="row2" align="center">
    ...
    <tr>
        ...
        <td class="row2" align="center">
            <input type="text" size="4" maxlength="4" name="send_width" value="{SEND_WIDTH}" />
        </td>
        <td class="row2" align="center">
