<!-- $Id: attach_quota_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
...
<form method="post" action="{S_ATTACH_ACTION}">
  <table width="99%" align="center" cellpadding="4" cellspacing="1" border="0" class="forumline">
    <tr>
      <td class="catHead" colspan="5" align="center"><span class="cattitle">{L_MANAGE_QUOTAS_TITLE}</span>
      </td>
    </tr>
    <tr>
    ...
    <tr align="right">
      <td class="catBottom" colspan="5"> {S_HIDDEN_FIELDS} <input type="submit" name="submit" class="liteoption" value="{L_SUBMIT}" /></td>
    </tr>
    <tr>
        <th class="thCornerL">{L_DESCRIPTION}</th>
        <th class="thTop">{L_SIZE}</th>
...
<!-- END limit_row -->
    <tr align="right">
      <td class="catBottom" colspan="5"> <input type="submit" name="submit" class="liteoption" value="{L_SUBMIT}" /></td>
    </tr>
</table>
</form>
