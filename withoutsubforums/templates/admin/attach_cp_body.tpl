<!-- $Id: attach_cp_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  <tr>
    <th width="50%" nowrap="nowrap" class="thCornerL">{L_STATISTIC}</th>
    <th width="50%" class="thCornerR">{L_VALUE}</th>
  </tr>
  <tr>
