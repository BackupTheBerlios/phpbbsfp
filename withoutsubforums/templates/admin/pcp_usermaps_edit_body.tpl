<!-- $Id: pcp_usermaps_edit_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
<h1>{L_TITLE}</h1>
...
<tr>
	<td class="row3" colspan="2">
		...
		<!-- END none -->
		<tr>
			<td class="catbottom" align="center" colspan="{block.SPAN}"><input type="submit" name="add_{block.BUTTON}" value="{block.L_BUTTON}" class="liteoption" /></td>
		</tr>
		</table>
	</td>
</tr>
