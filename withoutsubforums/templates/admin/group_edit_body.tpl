<!-- $Id: group_edit_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
<h1>{L_GROUP_TITLE}</h1>
...
<form action="{S_GROUP_ACTION}" method="post" name="post"><table border="0" cellpadding="3" cellspacing="1" class="forumline" align="center">
    ...
    <tr>
      ...
      <td class="row2" width="62%"><input class="post" type="text" name="username" maxlength="50" size="20" value="{GROUP_MODERATOR}" /> &nbsp; <input type="submit" name="usersubmit" value="{L_FIND_USERNAME}" class="liteoption" onClick="window.open('{U_SEARCH_USER}', '_minervasearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></td>
    </tr>
    <tr>
      <td class="row1" width="38%"><span class="gen">{L_GROUP_PRIORITY}:</span><br /><span class="gensmall">{L_GROUP_PRIORITY_EXPLAIN}</span></td>
      <td class="row2" width="62%"><select class="post" name="priority">{S_GROUP_PRIORITY}</select></td>
    </tr>
    <tr>
      <td class="row1" width="38%"><span class="gen">{L_GROUP_STATUS}:</span></td>
      <td class="row2" width="62%">
        <input type="radio" name="group_type" value="{S_GROUP_OPEN_TYPE}" {S_GROUP_OPEN_CHECKED} /> {L_GROUP_OPEN} &nbsp;&nbsp;<input type="radio" name="group_type" value="{S_GROUP_CLOSED_TYPE}" {S_GROUP_CLOSED_CHECKED} />  {L_GROUP_CLOSED} &nbsp;&nbsp;<input type="radio" name="group_type" value="{S_GROUP_HIDDEN_TYPE}" {S_GROUP_HIDDEN_CHECKED} /> {L_GROUP_HIDDEN} &nbsp;&nbsp;<input type="radio" name="group_type" value="{S_GROUP_AUTO_TYPE}" {S_GROUP_AUTO_CHECKED} /> {L_GROUP_AUTO}</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td class="row2" width="62%">
        <input type="checkbox" name="group_ldap_update" value="1" {S_GROUP_LDAP_UPDATE} /> {L_YES}</td>
    </tr>
    <tr>
      ...
      <td class="row2" width="62%">
        <input type="checkbox" name="delete_old_moderator" value="1" /> {L_YES}</td>
    </tr>
    <tr>
