<!-- $Id: index_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
<h1>{L_WELCOME}</h1>
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  <tr>
    <th width="25%" nowrap="nowrap" class="thCornerL">{L_STATISTIC}</th>
    <th width="25%" class="thTop">{L_VALUE}</th>
    <th width="25%" nowrap="nowrap" class="thTop">{L_STATISTIC}</th>
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
  ...
  <tr>
    ...
    <td width="20%" class="{reg_user_row.ROW_CLASS}">&nbsp;<span class="gen"><a href="{reg_user_row.U_WHOIS_IP}" class="gen" target="_minervawhois">{reg_user_row.IP_ADDRESS}</a></span>&nbsp;</td>
  </tr>
  <!-- END reg_user_row -->
  <tr>
    <td colspan="5" height="1" class="row3"><img src="{TEMPLATE}images/spacer.gif" width="1" height="1" alt="."></td>
  </tr>
  ...
  <tr>
    ...
    <td width="20%" class="{guest_user_row.ROW_CLASS}">&nbsp;<span class="gen"><a href="{guest_user_row.U_WHOIS_IP}" target="_minervawhois">{guest_user_row.IP_ADDRESS}</a>&nbsp;&nbsp;&nbsp;{guest_user_row.SHOWUSERAGENT}</span>&nbsp;</td>
  </tr>
  <!-- END guest_user_row -->
</table>
{JR_ADMIN_INFO_TABLE}
