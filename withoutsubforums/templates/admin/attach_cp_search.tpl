<!-- $Id: attach_cp_search.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
...
<table class="forumline" width="100%" cellpadding="4" cellspacing="1" border="0">
    <tr>
        <th class="thHead" colspan="4">{L_ATTACH_SEARCH_QUERY}</th>
    </tr>
    <tr>
    ...
    <tr>
        <td class="catBottom" colspan="4" align="center">{S_HIDDEN_FIELDS}<input class="liteoption" type="submit" name="search" value="{L_SEARCH}" /></td>
    </tr>
</table>
