<!-- $Id: portal_config_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
...
<table cellpadding="3" cellspacing="1" border="0" align="center" class="forumline">
    ...
    <tr>
        <td class="cat" colspan="2" align="center">{S_HIDDEN_FIELDS}
            <input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp; <input type="reset" value="{L_RESET}" class="button" />
        </td>
    </tr>
</table>
</form>
