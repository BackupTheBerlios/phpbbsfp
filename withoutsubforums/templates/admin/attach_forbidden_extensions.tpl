<!-- $Id: attach_forbidden_extensions.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
...
<form method="post" action="{S_ATTACH_ACTION}">
  <table width="99%" align="center" cellpadding="4" cellspacing="1" border="0" class="forumline">
    ...
    <tr align="right">
      <td class="catBottom" colspan="5"> {S_HIDDEN_FIELDS} <input type="submit" name="submit" class="liteoption" value="Submit" /></td>
    </tr>
    <tr>
      <th class="thLeft">&nbsp;{L_EXTENSION}&nbsp;</th>
...
<!-- END extensionrow -->
    <tr align="right">
      <td class="catBottom" colspan="5"> <input type="submit" name="submit" class="liteoption" value="Submit" /></td>
    </tr>
</table>
