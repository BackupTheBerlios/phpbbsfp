<!-- $Id: blocks_edit_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
...
bbcode = new Array();
bbtags = new Array('[b]','[/b]','[i]','[/i]','[u]','[/u]','[quote]','[/quote]','[code]','[/code]','[list]','[/list]','[list=]','[/list]','[img]','[/img]','[url]','[/url]'{CUSTOM_BBCODES_TAGS});
imageTag = false;
          ...
          <tr>
            <td valign="middle" align="center"> <br />
              <table width="100" border="0" cellspacing="0" cellpadding="5">
                ...
                <tr align="center">
                  <td colspan="{S_SMILIES_COLSPAN}"><span  class="nav"><a href="{U_BBCODES}" onclick="window.open('{U_BBCODES}', '_minervabbcodes', 'HEIGHT=300,resizable=yes,scrollbars=yes,WIDTH=250');return false;" target="_minervabbcodes" class="nav">{L_BBCODES}</a></span></td>
                </tr>
              </table>
            </td>
          </tr>
...
<table width="450" border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td colspan="9">
              <!-- BEGIN custom_bbcodes -->
              <span class="genmed">
                <input type="button" class="button" name="addbbcode{custom_bbcodes.JS_ID}" value="{custom_bbcodes.TAG}" onclick="bbstyle({custom_bbcodes.JS_ID})" />
              </span>
              <!-- END custom_bbcodes -->
            </td>
          </tr>
