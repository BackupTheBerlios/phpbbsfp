<!-- $Id: admin_pcount_resync_adv.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
<a name="top"></a>
...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline">
    ...
    <tr>
        <td class="row1" align="center"><input type="text" class="post" name="username" maxlength="50" size="20" /> <input type="submit" name="usersubmit" value="{L_USER_FIND}" class="liteoption" onClick="window.open('{S_FIND_USERNAME}', '_minervasearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></td>
    </tr>
    <tr>
