<!-- $Id: admin_prune_user_posts.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
...
<table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
    ...
    <tr>
        <td class="row1"><span class="gen">{L_USERNAME}: <input type="text" class="post" name="username" maxlength="50" size="20" /> <input type="submit" name="usersubmit" value="{L_FIND_A_USERNAME}" class="liteoption" onClick="window.open('{S_SEARCH_ACTION}', '_minervasearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></span></td>
