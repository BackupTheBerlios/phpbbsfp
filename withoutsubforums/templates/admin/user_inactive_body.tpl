<!-- $Id: user_inactive_body.tpl,v 1.1 2004/08/30 21:30:08 dmaj007 Exp $ -->
{JS_SCRIPT}
...
<table cellspacing="2" cellpadding="4" border="0">
 ...
 <tr>
 	<td bgcolor="#00FF00">{L_ALERT_UPTO} {ALERT_DAYS} {L_ALERT_DAYS}</td>
 	<td bgcolor="#FFFF00">{L_ALERT_UPTO} {ALERT_DAYS2} {L_ALERT_DAYS}</td>
 	<td bgcolor="#FFCC00">{L_ALERT_UPTO} {ALERT_DAYS3} {L_ALERT_DAYS}</td>
 	<td bgcolor="#FF9900">{L_ALERT_UPTO} {ALERT_DAYS4} {L_ALERT_DAYS}</td>
 	<td bgcolor="#FF6600">{L_ALERT_UPTO} {ALERT_DAYS5} {L_ALERT_DAYS}</td>
 	<td bgcolor="#FF0000">{L_ALERT_OVER} {ALERT_DAYS_OVER} {L_ALERT_DAYS}</td>
 </tr>
 </table><br /><br />
...
<tr>
	...
	<td class="{Table_InactiveUsers.ROW_CLASS}"><a href="mailto:{Table_InactiveUsers.EMAIL}">{Table_InactiveUsers.EMAIL}</a></td>
...
<tr>
	<td class="row3" colspan="10" align="center"><nobr>
		<a href="#" onclick="setCheckboxes('tablesForm', true); return false;">{L_CHECKALL}</a>&nbsp;/&nbsp;<a href="#" onclick="setCheckboxes('tablesForm', false); return false;">{L_UNCHECKALL}</a>&nbsp;/&nbsp;<a href="#" onclick="setCheckboxes('tablesForm', 'invert'); return false;">{L_INVERTCHECKED}</a></nobr>
	</td>
</tr>
