<!-- $Id: auth_ug_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
<h1>{L_AUTH_TITLE}</h1>
...
<td class="{forums.ROW_CLASS}" align="center">{forums.FORUM_NAME}</td>
		<!-- BEGIN aclvalues -->
		<td class="{forums.ROW_CLASS}" align="center">{row.forums.aclvalues.S_ACL_SELECT}</td>
		<!-- END aclvalues -->
		<td class="{forums.ROW_CLASS}" align="center">{row.forums.S_MOD_SELECT}</td>
    </tr>
    <!-- END forums -->
    <tr>
