<!-- $Id: db_utils_optimize_body.tpl,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $ -->
{SELECT_SCRIPT}
...
<tr>
    <td colspan="6" height="1" class="spaceRow"><img src="{TEMPLATE}images/spacer.gif" alt="" width="1" height="1" /></td>
</tr>
