...
//----------------------------------------------------------------------------------------[English]-
//
// $Id: lang_xs.php,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $
//
// FILENAME  : lang_xs.php
// STARTED   : Tue Jan 1, 2004
// COPYRIGHT : © 2003, 2004 Project Minerva Team
//           : © 2001, 2003 The phpBB Group
//           : © 2004       Vjacheslav Trushkin
...
$lang['xs_ftp_host_guess'] = ' (probably "{HOST}" [<a href="javascript: void()" onclick="{CLICK}">set host</a>])';
$lang['xs_ftp_login_guess'] = ' (probably "{LOGIN}" [<a href="javascript: void()" onclick="{CLICK}">set host</a>])';
$lang['xs_ftp_path_guess'] = ' (probably "{PATH}" [<a href="javascript: void()" onclick="{CLICK}">set path</a>])';
