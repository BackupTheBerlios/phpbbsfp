...
//----------------------------------------------------------------------------------------[English]-
//
// $Id: lang_extend_pcp_management.php,v 1.1 2004/08/30 21:30:06 dmaj007 Exp $
//
// FILENAME  : lang_extend_pcp_management.php
...
if ( $lang_extend_admin )
{
    ...
    $lang['PCP_tableslinked_join_explain'] = 'FROM statement used in SQL requests.<hr />&raquo;&nbsp;Use [cst.<i>table constant</i>] to get back the real table name.<br />(ie : [cst.USERS_TABLE] for minerva_users).<hr />&raquo;&nbsp;Use [<i>Tables linked name</i>] to identify the SQL id.<br />(ie: [USERS].username)<hr />Example: [cst.USERS_TABLE] AS [USERS]';
