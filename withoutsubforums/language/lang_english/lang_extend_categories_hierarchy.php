...
//----------------------------------------------------------------------------------------[English]-
//
// $Id: lang_extend_categories_hierarchy.php,v 1.1 2004/08/30 21:30:06 dmaj007 Exp $
//
// FILENAME  : lang_extend_categories_hierarchy.php
...
if ( $lang_extend_admin )
{
    ...
    $lang['Forum_link_url_explain']                 = 'You can set here an URI to a Minerva program, or a full URL to an external server';
    $lang['Forum_link_internal']                    = 'Minerva Program';
    $lang['Forum_link_internal_explain']            = 'Choose Yes if you invoke a program is located in the Minerva directories';
