...
//----------------------------------------------------------------------------------------[English]-
//
// $Id: lang_rate.php,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $
//
// FILENAME  : lang_rate.php
...
$lang['Rate_Stats'] = "Average Rating: <b>%.2f</b> :: Min Rating: <b>%d</b> :: Max Rating: <b>%d</b> :: Number of Ratings: <b>%d</b>"; //%.2f = average, %d = min, %d = max, %d # of ratings
$lang['Rate'] = "Rate";
...
$lang['View_Details'] = ' :: <a href="%s" alt="View Details">View detailed info</a>'; //%s = detailed URL
$lang['View_Details_2'] = '<a href="%s" alt="View Details">View detailed info</a>'; //%s = detailed URL
...
$lang['Details_For_Topic'] 	= "Rating Details For >> <b>%s</b>"; //%s = topic title
...
$lang['Summary'] = "Summary Rating For >> ";
