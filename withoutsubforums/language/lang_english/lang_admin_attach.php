...
//----------------------------------------------------------------------------------------[English]-
//
// $Id: lang_admin_attach.php,v 1.1 2004/08/30 21:30:06 dmaj007 Exp $
//
// FILENAME  : lang_admin_attach.php
...
$lang['Upload_directory_explain'] = 'Enter the relative path from your Minerva installation to the Attachments upload directory. For example, enter \'files\' if your Minerva Installation is located at http://www.yourdomain.com/minerva and the Attachment Upload Directory is located at http://www.yourdomain.com/minerva/files.';
$lang['Attach_img_path'] = 'Attachment Posting Icon';
$lang['Attach_img_path_explain'] = 'This Image is displayed next to Attachment Links in individual Postings. Leave this field empty if you don\'t want an icon to be displayed. This Setting will be overwritten by the Settings in Extension Groups Management. The path for your image is relative to the image directory in your template.';
$lang['Attach_topic_icon'] = 'Attachment Topic Icon';
$lang['Attach_topic_icon_explain'] = 'This Image is displayed before topics with Attachments. Leave this field empty if you don\'t want an icon to be displayed. The path for your image is relative to the image directory in your template.';
...
$lang['Ftp_download_path_explain'] = 'Enter the URL to your FTP Path, where your Attachments are stored.<br />If you are using a Remote FTP Server, please enter the complete url, for example http://www.mystorage.com/minerva/upload.<br />If you are using your Local Host to store your Files, you are able to enter the url path relative to your Minerva Directory, for example \'upload\'.<br />A trailing slash will be removed. Leave this field empty, if the FTP Path is not accessible from the Internet. With this field empty you are unable to use the physical download method.';
