...
//--------------------------------------------------------------------------------------------------
//
// $Id: def_userfuncs_std.php,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $
//
// FILENAME	 : def_userfuncs_std.php
...
//-----------------------------------
//
// user_donate output function
//
//-----------------------------------

//-----------------------------------
//
// user_cashadmin output function
//
//-----------------------------------

//-----------------------------------
//
// user_donate2 output function
//
//-----------------------------------
...
function pcp_output_holidays($field_name, $view_userdata, $map_name='')
{
    ...
    if ( $view_userdata['user_id'] != ANONYMOUS )
    {
        switch ($view_userdata[$field_name])
        {
            case 0:
                $txt = $lang['No'];
                $img = '<img src="' . $images['No'] . '" border="0" alt="' . $lang['No'] . '" title="' . $lang['No'] . '" />';
                break;
            case 1:
                $txt = $lang['Yes'];
                ...
                break;
            case 2:
                $txt = $lang['No_holidays_specify'];
                //$res = '<img src="' . $images['No_holidays_specify'] . '" border="0" alt="' . $lang['No_holidays_specify'] . '" title="' . $lang['No_holidays_specify'] . '" />';
                break;
        }
