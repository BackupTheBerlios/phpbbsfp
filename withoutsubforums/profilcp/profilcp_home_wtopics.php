...
//--------------------------------------------------------------------------------------------------
//
// $Id: profilcp_home_wtopics.php,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $
//
// FILENAME	 : profilecp_home_wtopics.php
...
{
	// get page parm
	$topics_watched_page_size = (isset($board_config['topics_watched_per_page'])) ? intval($board_config['topics_watched_per_page']) : 0;
