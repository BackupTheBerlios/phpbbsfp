...
//--------------------------------------------------------------------------------------------------
//
// $Id: profilcp_uacp.php,v 1.1 2004/08/30 21:30:07 dmaj007 Exp $
//
// FILENAME	 : profile_uacp.php
// STARTED	 : Tue Jan 1, 2004
// COPYRIGHT : © 2003, 2004	Project	Minerva	Team
//           : © 2001, 2003 The phpBB Group
//           : © 2003       Ptirhiik
//           : © 2002       Meik Sievertsen
...
if (count($attachments) > 0)
{
   for ($i = 0; $i < count($attachments); $i++)
   {
      ...
      for ($j = 0; $j < $num_ids; $j++)
      {
         ...
         {
            /* ##### Original PM code, needs migrating to Advanced PM code when attachment support is re-integrated. #####
      ...
      if (count($post_titles) > 0)
      {
         ...
         $template->assign_block_vars('attachrow', array(
            ...
            'COMMENT' => stripslashes(trim(nl2br(htmlspecialchars($attachments[$i]['comment'])))),
